      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="fsec">
          ...
          <div className="ff">
            ...
            <textarea name="target_customer" placeholder="Our customer is... There are approximately X of them... The TAM is estimated at..." maxLength={300} value={form.target_customer} onChange={handleChange} style={{ minHeight: '80px' }} required />
          ...
          <div className="ff">
            ...
            <textarea name="domain_expertise" placeholder="I have X years in this space... My unfair advantage is..." maxLength={300} value={form.domain_expertise} onChange={handleChange} style={{ minHeight: '80px' }} required />
          ...
          <div className="ff">
            ...
            <textarea name="competitors" placeholder="Direct competitors are... We're different because..." maxLength={300} value={form.competitors} onChange={handleChange} style={{ minHeight: '80px' }} required />
          ...
          <div className="ff">
            ...
            <textarea name="revenue_model" placeholder="We charge... Our unit economics are... At scale this could be..." maxLength={300} value={form.revenue_model} onChange={handleChange} style={{ minHeight: '80px' }} required />
        ...
        <div className="fsec">
          ...
          <div className="ff">
            ...
            <div className="fh">Upload to Google Drive → share with "Anyone with the link" → paste the link here</div>
